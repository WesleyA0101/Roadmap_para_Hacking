...
4. [⚔️ Ataques que Marcaram a História](#4---ataques-que-marcaram-a-história)  
5. [👨‍💻 Pessoas que fizeram história em invasões](#5-Pessoas-que-fizeram-história-em-invasões)  
...
**Uso da palavra hacker em 1950:**

*Origem no MIT (Massachusetts Institute of Technology):*

<div align="center">
  <img src="https://th.bing.com/th/id/OIP.w48c-fQLHWQaxRbYIpne8gHaEK?rs=1&pid=ImgDetMain" width="400" alt="MIT" />
</div> 
...
<div align="center">
  <img src="https://th.bing.com/th/id/OIP.z_Kk82irrHEtIIEhn_tTKAHaLH?w=156&h=220&c=7&r=0&o=5&pid=1.7" width="190" alt="Stallman" />
</div> 
...
*Classificações Criadas pelos Técnicos:*

### 1. **White Hat Hackers (Chapéu Branco)**
...
**Exemplo clássico:**
- Especialistas que testavam sistemas de segurança para empresas ou governos na época inicial da Internet.
- Desenvolvedores de padrões de criptografia, como o **RSA**.


### 2. **Black Hat Hackers (Chapéu Preto)**
...
**Motivação:** Ganhos financeiros, vingança, ego ou simples diversão (muitas vezes irresponsável).

**Exemplo clássico:**
- **Kevin Mitnick** (antes de se reformar e virar um consultor ético).
- Grupos que invadiam sistemas telefônicos para **phreaking**.


### 3. **Grey Hat Hackers (Chapéu Cinza)**
...
**Exemplo clássico:**
- Hackers que invadiam redes para alertar sobre vulnerabilidades, mesmo sem autorização.
...
**Exemplo clássico:**
- Iniciantes nos anos 90 que usavam scripts básicos para explorar falhas conhecidas de sistemas Windows.
...
**Exemplo clássico:**
- Grupos como o **Cult of the Dead Cow (cDc)**, conhecidos por misturar ativismo com hacking.
- **Julian Assange**, que começou como hacker antes de fundar o **WikiLeaks**.


### 6. **Phreakers**
**Definição:** Hackers especializados em explorar sistemas telefônicos, muito comuns nas décadas de 1970 e 1980.

**Motivação:** Curiosidade ou desejo de obter chamadas gratuitas.

**Exemplo clássico:**
- **John Draper (Captain Crunch)**, que descobriu como usar apitos de cereal para manipular sistemas telefônicos.
  

### 7. **Elite Hackers**
**Definição:** Hackers altamente qualificados que desenvolvem suas próprias ferramentas e métodos. Eles são respeitados dentro da comunidade por sua capacidade técnica.

**Motivação:** Curiosidade, inovação e status na comunidade hacker.

**Exemplo clássico:**
- Desenvolvedores do primeiro malware ou exploits para sistemas emergentes.


### 8. **Newbies (ou Noobs)**
**Definição:** Iniciantes que ainda estão aprendendo as bases do hacking. Muitas vezes cometem erros e dependem de guias e fóruns.

**Motivação:** Aprendizado ou tentativa de ingressar no mundo hacker.

**Exemplo clássico:**
- Jovens nos anos 80 aprendendo a usar os primeiros computadores pessoais.


### 9. **Cyberpunks**
**Definição:** Hackers influenciados pela estética e filosofia do movimento cyberpunk, combinando hacking com visões distópicas e críticas ao sistema.

**Motivação:** Rejeição ao controle corporativo e governamental.

**Exemplo clássico:**
- Hackers inspirados em obras como **Neuromancer**, de **William Gibson**.


### 10. **Lammers**
**Definição:** Amadores que tentam imitar os mais experientes, mas sem habilidades técnicas reais. São frequentemente desorganizados e fáceis de identificar.

**Motivação:** Ego ou desejo de reconhecimento.

**Exemplo clássico:**
- Pessoas nos anos 90 que inundavam canais de IRC com **"DDoS amador"**.


* 🌐 Fontes:

[**Um pouco sobre da história hacker**](https://users.cs.utah.edu/~elb/folklore/afs-paper/node3.html)
*Um estudo exploratório sobre a origem dos hackers no MIT.*

[**Ética hacker**](https://pt.wikipedia.org/wiki/%C3%89tica_hacker)
*Um artigo da Wikipédia que descreve os valores morais e filosóficos na comunidade hacker.*

[**Revolution OS**](https://www.youtube.com/watch?v=Z3f-M43DiD4)
*(2001): Um documentário sobre a história do movimento do software livre e a cultura hacker.*

[**The Code**](https://www.youtube.com/watch?v=qtXYXLeeU5s)
*(2001): Um documentário sobre a criação do Linux e a cultura hacker.*

[**O Segredo dos Hackers Puro-Sangue**](https://www.youtube.com/watch?v=cHiEOtZP-Mo)
*Um vídeo no YouTube que explora a verdadeira cultura hacker.*
...
**Aqui vou mostrar alguns 'reis' do marketing, que são alguns dos responsáveis pela fabricação de script kiddies:**

**Bruno Fraga:**

<div align="center">
  <img src="https://th.bing.com/th/id/OIP.scsw8THrbbgM2xEs1BngEgAAAA?w=177&h=180&c=7&r=0&o=5&pid=1.7" width="190" alt="Cabeça quadrada" />
</div> 
...
Link do Podcast: [**OS SEGREDOS DE UM HACKER: CARLA ALBUQUERQUE E BRUNO FRAGA - Inteligência Ltda. Podcast**](https://www.youtube.com/watch?v=kHGDB-V8zFs)
...
[**Reclamações no Reclame Aqui sobre os trinamentos do Bruno Fraga**](https://www.reclameaqui.com.br/empresa/bruno-fraga-treinamentos-e-consultoria/lista-reclamacoes/)

**FocoemSec/Antonio Dias:**

**Antonio Dias:**

<div align="center"> <img src="https://yt3.googleusercontent.com/G0dhJtDs4pluTaQDr7GBapVsCpL-MNQl9puLAlypRcjR8hcLL18qbtGgLAMU9E6nb4qr8QOSpw=s900-c-k-c0x00ffffff-no-rj" width="190" alt="Antonio" /> 
</div>
...
já citado, o último pur-sangue pe o grande Richard Stallman, um cara que sou extremamente fã.

<div align="center"> <img src="https://th.bing.com/th/id/OIP.LGj-WxDyO4FjgStqiLAApgHaF5?rs=1&pid=ImgDetMain" width="190" alt="Stallman" /> 
</div>

- Feitos e Contribuições

*Criação do GNU (GNU's Not Unix):*

<div align="center"> <img src="https://prdm0.github.io/aulas_computacional/images/logo_gnu.png" width="190" alt="GNU" /> 
</div>
...
<div align="center"> <img src="https://th.bing.com/th/id/R.c25b077deac243d2cf019d2fd74079fc?rik=nfiA8%2bo57Zlzfg&riu=http%3a%2f%2fstatic.fsf.org%2fnosvn%2fstickers%2ffsf.svg&ehk=q28EhvLaOsMoqR9GzLtK4H1qhI2tgKT05dXkAjORjpE%3d&risl=&pid=ImgRaw&r=0" alt="GNU" /> 
</div>
...
[**Projeto GNU**](https://www.gnu.org/home.pt-br.html)

[**Documentário Revolution OS**](https://documentaryheaven.com/revolution-os/)

[**Documentário Revolution OS legendado em PT-BR**](https://www.youtube.com/watch?v=Z3f-M43DiD4)

[**Biografia na InfoEscola**](https://www.infoescola.com/biografias/richard-stallman/)
*Por Anna Adami: Um artigo detalhado sobre a trajetória de Stallman pode ser encontrado*

---

### 4 - ⚔️ Ataques que Marcaram a História
...
[**Link**](https://g1.globo.com/tecnologia/noticia/yahoo-afirma-que-ciberataque-de-2013-afetou-todas-as-3-bilhoes-de-contas-de-usuarios.ghtml)
...
[**Link**](https://pt.wikipedia.org/wiki/Stuxnet)
...
[**Link**](https://www.msn.com/en-us/money/other/how-to-claim-a-2nd-payment-from-the-equifax-data-breach-settlement/ar-AA1wkJYg)
...
[**Link**](https://www.cloudflare.com/pt-br/learning/security/ransomware/wannacry-ransomware/)
...
[**Link**](https://www.cisecurity.org/solarwinds)
...
[**Link**](https://www.csoonline.com/article/562859/the-heartbleed-bug-how-a-flaw-in-openssl-caused-a-security-crisis.html)
...
[**Link**](https://en.wikipedia.org/wiki/2014_Sony_Pictures_hack)
...
[**Link**](https://www.commerce.senate.gov/services/files/24d3c229-4f2f-405d-b8db-a3a67f183883)
...
### 5 - 👨‍💻 Pessoas que fizeram história em invasões

### **Kevin Mitnick** (Black Hat Hacker, posteriormente White Hat)
...
- [https://www.kevinmitnick.com](https://www.kevinmitnick.com/)


### **Adrian Lamo** (Grey Hat Hacker)
...
- [https://www.wired.com](https://pt.wikipedia.org/wiki/Adrian_Lamo)


### **Gary McKinnon** (Black Hat Hacker)
...
**Fontes:**  
- [https://www.bbc.com/news/uk-19946902](https://www.bbc.com/news/uk-19946902)


### **Albert Gonzalez** (Black Hat Hacker)
...
### **Jonathan James** (Black Hat Hacker)
...
### **Kevin Poulsen** (Black Hat Hacker, posteriormente White Hat)
...
### 6 - 🖥️ A Filosofia do Software Livre
...
As redes de computadores são compostas por interconexões físicas (como cabos e roteadores) e lógicas (protocolos e sistemas de comunicação) que permitem que dispositivos troquem informações entre si. Existem vários tipos de redes, 
...
Por que é Importante Aprender Redes para Hacking?
...
MITM: O hacker intercepta e possivelmente altera a comunicação entre dois dispositivos em uma rede.
...
Como Aprender Redes para Hacking?
...
# Recursos para Estudo de Redes de Computadores

## Livros:

- [**Redes de Computadores - Andrew S. Tanenbaum e David J. Wetherall.**](https://www.amazon.com.br/s/?ie=UTF8&keywords=tanenbaum+redes&index=aps&tag=msndesktopsta-20&ref=pd_sl_1s7lp7l2dl_p&adgrpid=1147890797867306&hvadid=71743340877750&hvnetw=o&hvqmt=p&hvbmt=bp&hvdev=c&hvlocint=&hvlocphy=147525&hvtargid=kwd-71743690252947:loc-20&hydadcr=5625_13210264&mcid=)
- [**Computer Networking: A Top-Down Approach - James Kurose e Keith Ross.**](Computer Networking: A Top-Down Approach - James Kurose e Keith Ross)
- [**Network Programmability and Automation - Jason Edelman.**](https://www.amazon.com.br/s?k=network+programmability+and+automation&adgrpid=1142393240031765&hvadid=71399743810014&hvbmt=bp&hvdev=c&hvlocphy=147525&hvnetw=o&hvqmt=p&hvtargid=kwd-71400092239280%3Aloc-20&hydadcr=5690_13210500&tag=msndesktopsta-20&ref=pd_sl_7hzhlecssy_p)
- [**Network Warrior - Gary A. Donahue.**](https://archive.org/details/networkwarrior0000dona)
- [**CompTIA Network+ Certification All-in-One Exam Guide - Mike Meyers.**](https://www.amazon.com/CompTIA-Network-Certification-Eighth-N10-008-ebook/dp/B09PYFT7X7)

## PDFs e Apostilas:

- [**10 Livros de Redes de Computadores Grátis! [PDF] - InfoLivros.**](https://www.infolivros.org/livros-pdf-gratis/informatica/redes-de-computadores/)
- [**Apostila de Redes - Universidade do Vale do Paraíba.**](https://www1.univap.br/bruno.pera/uploads/INFORMATICA/REDES/Apostila_de_Redes_V3.pdf)

## Cursos Online:

- [**CompTIA Network+ (N10-007) Curso Completo e Exame Prático - Udemy.**](https://www.udemy.com/course/network-n10-007-the-complete-course/?couponCode=2021PM25)
- [**Os bits e bytes das redes de computadores - Coursera.**](https://www.coursera.org/learn/computer-networking?msockid=2db7c7c237056f4c0554d32036116e37)
- [**Fundamentos da comunicação em rede - Coursera.**](https://www.coursera.org/learn/redes-computadores?msockid=2db7c7c237056f4c0554d32036116e37)
- [**Introdução à rede para iniciantes completos - Udemy.**](https://www.udemy.com/course/introducao-as-redes-de-computadores/?couponCode=2021PM25)

## Plataformas de Estudo:

- [**Prime Cursos** - Curso de Redes de Computadores Online Grátis.](https://www.primecursos.com.br/busca/?termo=Redes+de+Computadores&search-button=)
- [**FIAP** - Cursos gratuitos e online.](https://www.fiap.com.br/graduacao/tecnologo/redes-de-computadores/)
- [**Hackeone**](https://hackone.com.br/)
...
1. Função de Controle e Gerenciamento
...
2. Estrutura de Arquivos e Gerenciamento de Permissões
...
3. Abstração de Hardware e Interação com a Rede
...
4. Vulnerabilidades e Exploração de Sistemas
...
5. Isolamento e Contenção de Processos
...
6. Gerenciamento de Conexões de Rede
...
8. Forense e Análise Pós-Comprometimento
...
9. Resposta a Incidentes e Mitigação de Riscos
